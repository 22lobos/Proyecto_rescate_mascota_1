...
import androidx.compose.foundation.text.KeyboardOptions   // ✅ usa FOUNDATION, no UI
...
fun RecoverPasswordScreen(
    ...
    Scaffold(
            ...
            TopAppBar(
                ...
                navigationIcon = {
                    IconButton(onClick = { navController.popBackStack() }) {
                        Icon(
                            imageVector = Icons.Filled.ArrowBack, // <- usa Filled, coincide con el import
        ...
        Column(
            ...
            Text(
                "Ingresa tu correo y te enviaremos un link o código para restablecer tu contraseña.",
            ...
            OutlinedTextField(
                ...
                keyboardOptions = KeyboardOptions(           // <- usa el tipo importado
